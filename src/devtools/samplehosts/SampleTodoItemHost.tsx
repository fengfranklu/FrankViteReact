...
import SampleTodoItem from '../samplecomponents/SampleTodoItem';
import { Todo } from '../../types/todo';

export default function SampleTodoItemHost() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-2xl">
      <h1 className="text-2xl font-bold mb-4">Sample TodoItem Component Demo</h1>
